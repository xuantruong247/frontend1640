...
const LoginPage = () => {
  ...
  const login = async (e) => {
    ...
    try {
      ...
      if (res.data.users.role.name === "admin") {
        return navigate("/submissionAdmin");
      }
      if (res.data.users.role.name === "QA") {
        return navigate("/submissionQA");
      }
      if (res.data.users.role.name === "user") {
      ...
      <div className="login-title">
        <div className="my-[20px] flex items-center justify-center">
          <div className="w-full  max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-end">
                  <a
                    ...
                    href="#"
                    className="text-gray-400 hover:text-gray-100 no-underline"
                  >
                    Forgot Password?
                  </a>
                </div>
            ...
            <p className="text-center sm:px-6 text-gray-400 text-sm">
              Don't have an account?
              <a
                rel="noopener noreferrer"
                href="#"
                className="underline text-gray-100 hover:text-gray-50"
              >
                Sign up
              </a>
            </p>
